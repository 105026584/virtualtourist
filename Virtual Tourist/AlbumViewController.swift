...
class AlbumViewController: UIViewController, UICollectionViewDelegate {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        if pin.photos!.count == 0 || newPin == true {
            //no photos yet, get some ( check on new pin )
            print("fetching new set of photos")
            getImageSet()
        } else {
    ...
    func setNewCollectionButton() {
        ...
        bottomButton.setTitleColor(UIColor.grayColor(), forState: UIControlState.Disabled)
    }
    ...
    func configureCell(cell: AlbumCollectionViewCell, photo: Photo) {
        ...
        if photo.path == nil || photo.path == "" {
            ...
            // This is the custom property on this cell. See AlbumCollectionViewCell for details.
